...
<div class="container">
			...
			<div class="panel panel-login">
				<div class="panel-heading">
						<div class="row">
							...
							<div class="col-xs-6">
								<a href="view/register.php" id="register-form-link">Register</a>
							</div>
						</div>
						<hr>
					</div>
					<div class="panel-body">
						<div class="row">
							<div class="col-lg-12">
								<form id="login-form" action="modal/switch.php?action=login" method="post" role="form" style="display: block;">
								...
								<!-- <form id="register-form" action="modal/switch.php?action=register" method="post" role="form" style="display: none;">
									<div class="form-group">
	...
	<script>
		...
		alert('<?php echo $response['response']; ?>');
	</script>